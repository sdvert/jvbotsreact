...
def banner():
    ...
    print(f'{gr}-------------- ROBÔ DE INTERACOES--------------- {re}')
    print(f'{re}------------------------------------------------------------------ {r}')
    print(f'{gr}Criado por Youtube:@JVBOTSBR & Telegram: @leadsstoreejvbots {re}')
...
def main_menu():
    ...
    print(Style.BRIGHT + Fore.CYAN+'   [5] COMPRE Números de Telegram Prontos Aquí!'+n)
    print(Style.BRIGHT + Fore.CYAN+'   [6] COMPRE Membros Fake para fazer Volume no seu grupo do Telegram Aquí!'+n)
    print(Style.BRIGHT + Fore.CYAN+'   [7] Gerar REAÇÕES em postagens'+n)
    print(Style.BRIGHT + Fore.CYAN+'   [8] Gerar VISUALIZAÇÕES em postagens'+n)
    print(Style.BRIGHT + Fore.CYAN+'   [9] PACK de FERRAMENTAS e PROGRAMAS por 19.99 R$!'+n)
    print(Style.BRIGHT + Fore.CYAN+'   [10] 28 Estrategias para Dobrar seu faturamento em 30 dias!'+n)
    print(Style.BRIGHT + Fore.CYAN+'   [11] Manual do Criador Digital (GRÁTIS)'+n)
